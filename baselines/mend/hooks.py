...
def hook_model(model, pnames):
    handles = []
    # parent_module -> get the parent module of the inner params
    # inner params -> weight for example, model.encoder.layers.4.fc1.weight
    # parent_module of inner params -> model.encoder.layers.4.fc1
    ...
    # additional hint: hook function can be used to edit the output of the
    # certain layer
