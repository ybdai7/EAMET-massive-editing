...
from .alphaedit_aligned_hparams import AlphaEditAlignedHyperParams
...
def apply_AlphaEditAligned_to_model(
    model: AutoModelForCausalLM,
    tok: AutoTokenizer,
    requests: List[Dict],
    hparams: AlphaEditAlignedHyperParams,
    copy=False,
  ...
  #-> Tuple[AutoModelForCausalLM, Dict[str, Any]]:
    ...
    deltas = execute_AlphaEditAligned(model, tok, requests, hparams, 
